...
async def seed_programs_db():
    ...
    seeds = [
        ...
        },
        {
            ...
            "description": "Los voluntarios trabajan en agencias de la ONU (como UNICEF, PNUD o ACNUR) apoyando proyectos de desarrollo social, derechos humanos, salud y educación en contextos de crisis o desarrollo.\n\nCubre estipendio mensual de subsistencia, gastos de viaje, seguro médico y subsidio de reasentamiento.",
            "type": "volunteering",
            "organization": "Programa de Voluntarios de las Naciones Unidas (UNV)",
            "country": "Global (África, Asia, Latinoamérica y Medio Oriente)",
            "deadline": None,
            "eligibility": "Jóvenes bolivianos entre 18 y 26 años con vocación social, título universitario o técnico (según vacante) y dominio de inglés o francés.",
            "benefits": "Estipendio mensual de subsistencia, pasajes aéreos y viajes, seguro médico y subsidio de reasentamiento.",
            "slots": 25,
            "slug": "un-voluntariado",
            "organization_name": "UNV",
            "status": "approved",
