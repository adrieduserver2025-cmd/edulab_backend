...
async def seed_programs_db():
    ...
    seeds = [
        ...
        {
            "title": "Becas de Excelencia Eiffel Francia (Máster & Ph.D.)",
            "description": "El programa de becas de élite del Ministerio de Europa y de Asuntos Exteriores de Francia para atraer a los mejores estudiantes internacionales a programas de Máster y Doctorado en universidades de Francia.",
            "type": "scholarship",
            "organization": "Ministerio de Europa y de Asuntos Exteriores de Francia & Campus France",
            "country": "Francia",
            "city": "París, Lyon, Toulouse, Marsella, Burdeos",
            "institution": "Universidades e Institutos de Educación Superior de Francia",
            "level": "Maestría / Doctorado (Cotutela)",
            "funding_type": "100% Total (Estipendio + Pasajes + Seguro + Alojamiento)",
            "area": "Ciencia y Tecnología / Ciencias Humanas y Sociales",
            "language": "Francés o Inglés",
            "duration": "12 a 36 meses",
            "deadline": datetime.date(2026, 1, 8),
            "official_url": "https://www.campusfrance.org/en/eiffel-scholarship-program-of-excellence",
            "eligibility": "Estudiantes extranjeros hasta 29 años (Máster) y hasta 35 años (Doctorado), postulados oficialmente por una universidad francesa.",
            "benefits": "Estipendio mensual de 1,200 € (Máster) o 2,100 € (Doctorado), boletos aéreos de ida y vuelta, transporte interno, seguro médico y residencia estudiantil CROUS.",
            "slots": 20,
            "slug": "eiffel-francia-beca",
            "organization_name": "Campus France",
            "status": "approved",
            "short_description": "Programa de élite del Gobierno Francés para realizar tu posgrado o doctorado en Francia.",
            "activities": [
                "Estudios de Máster o investigación doctoral 🎓",
                "Cotutela de tesis y proyectos científicos de vanguardia 🔬",
                "Viajes y actividades culturales por Francia 🥐",
                "Integración en la red France Alumni 🌍"
            ],
            "requirements": [
                "Ser postulado oficialmente por una universidad francesa",
                "Nacionalidad extranjera (no francesa)",
                "Hasta 29 años para Máster o 35 años para Doctorado",
                "Excelente récord académico y propuesta científica"
            ],
            "benefits_json": [
                "Estipendio mensual de 1,200 € (Máster) o 2,100 € (Doctorado) 💶",
                "Vuelos internacionales de ida y vuelta cubiertos ✈️",
                "Seguro médico integral de la Sécurité Sociale 🛡️",
                "Prioridad de reserva en residencias CROUS 🏠"
            ],
            "dates_info": "Convocatoria 2026: Cierre 8 de Enero de 2026 | Resultados: 30 de Marzo de 2026",
            "support_ai": [
                "Redactor de propuesta científica para universidad francesa",
                "Simulador de entrevista de admisión en francés e inglés",
                "Evaluador de compatibilidad de perfil Eiffel"
            ],
            "facebook_url": "https://www.facebook.com/CampusFranceParis/",
            "instagram_url": "https://www.instagram.com/campus_france/",
            "youtube_url": "https://www.youtube.com/user/ParisCampusFrance",
            "video_url": "https://www.youtube.com/watch?v=Yy9uN1k3Z6c",
            "image_url": "/assets/becas_Excelencia_Eiffel/images (2).jfif",
            "is_demo": False
        },
        {
            "title": "Becas de Excelencia e Investigación del Gobierno Suizo (FCS / ESKAS)",
            "description": "Becas de investigación de posgrado, Doctorado (Ph.D.) y estancias postdoctorales otorgadas directamente por la Confederación Suiza a través de la Comisión Federal de Becas para Estudiantes Extranjeros (FCS / SBFI).",
            "type": "scholarship",
            "organization": "Secretaría de Estado para la Educación, Investigación e Innovación de Suiza (SBFI / FCS)",
            "country": "Suiza",
            "city": "Zúrich, Ginebra, Lausana, Basilea, Berna",
            "institution": "ETH Zurich, EPFL, Universidades Cantonales e Institutos del Dominio ETH",
            "level": "Investigación / Doctorado / Posdoctorado",
            "funding_type": "100% Total (Estipendio + Seguro Salud Suizo + Vuelo de Retorno + 1/2 Tarifa SBB)",
            "area": "Todas las disciplinas académicas (Ciencia, Ingeniería, Humanidades, Salud)",
            "language": "Inglés, Francés, Alemán o Italiano",
            "duration": "12 a 36 meses",
            "deadline": datetime.date(2026, 11, 30),
            "official_url": "https://www.sbfi.admin.ch/en/swiss-government-excellence-scholarships",
            "eligibility": "Graduados universitarios con título de Máster o Doctorado con carta oficial de patrocinio de un profesor supervisor en una universidad suiza.",
            "benefits": "Estipendio mensual de 1,920 CHF (Ph.D.) o 3,500 CHF (Posdoc), seguro de salud suizo 100% cubierto, pasaje aéreo de retorno, tarjeta Half-Fare SBB y subsidio de 300 CHF de instalación.",
            "slots": 15,
            "slug": "suiza-research-fellowship-beca",
            "organization_name": "SBFI / FCS Suiza",
            "status": "approved",
            "short_description": "Desarrolla investigación científica de vanguardia en Suiza con financiamiento completo de la Confederación Suiza.",
            "activities": [
                "Investigación científica de alto nivel en laboratorios suizos 🔬",
                "Estudios doctorales y estancias postdoctorales 🎓",
                "Excursiones y eventos culturales organizados por la FCS 🇨🇭",
                "Red global de investigadores y exbecarios suizos 🌍"
            ],
            "requirements": [
                "Carta oficial de compromiso de un profesor supervisor en una universidad suiza",
                "Propuesta de investigación original detallada",
                "Título de Máster o Doctorado según modalidad",
                "Dominio del idioma de trabajo (Inglés, Francés o Alemán)"
            ],
            "benefits_json": [
                "Estipendio mensual de 1,920 CHF (Ph.D.) a 3,500 CHF (Posdoc) 💶",
                "Seguro médico obligatorio suizo financiado por la FCS 🛡️",
                "Vuelo de regreso a Bolivia financiado ✈️",
                "Tarjeta Half-Fare SBB para 50% de descuento en transporte suizo 🚆"
            ],
            "dates_info": "Convocatoria anual: Cierre en Noviembre a través de la Embajada Suiza en La Paz",
            "support_ai": [
                "Generador de correo formal a profesores suizos",
                "Redactor de propuestas científicas estándar SBFI",
                "Evaluador de compatibilidad de perfil investigador"
            ],
            "facebook_url": "https://www.facebook.com/SBFI.SEFRI.SERI",
            "youtube_url": "https://www.youtube.com/channel/UCucD43ut3DEx6QDK2JOEI1w",
            "video_url": "https://www.youtube.com/watch?v=iyBU0Vahbx8",
            "image_url": "/assets/beca_suiza_research/ETH_Zurich_from_Polyterrace.jpg",
            "is_demo": False
        },
        {
            "title": "Becas Chevening del Reino Unido (Chevening Scholarships)",
            "description": "Programa global de becas de élite del Gobierno del Reino Unido financiado por el Ministerio FCDO para realizar maestrías de 1 año totalmente cubiertas en universidades británicas.",
            "type": "scholarship",
            "organization": "Foreign, Commonwealth & Development Office (FCDO) UK",
            "country": "Reino Unido",
            "city": "Londres, Oxford, Cambridge, Edimburgo, Mánchester",
            "institution": "University of Oxford, Cambridge, LSE, Imperial College, UCL y 150+ universidades en UK",
            "level": "Maestría de 1 Año",
            "funding_type": "100% Total (Matrícula + Estipendio + Vuelos + Visa + Seguro)",
            "area": "Todas las disciplinas académicas (Liderazgo, Política, STEM, Humanidades, Economía)",
            "language": "Inglés (IELTS / TOEFL)",
            "duration": "12 meses",
            "deadline": datetime.date(2026, 11, 5),
            "official_url": "https://www.chevening.org/scholarships/",
            "eligibility": "Ciudadanos bolivianos con título de Licenciatura, mínimo 2 años de experiencia laboral (2.800 horas) y compromiso de retorno por 2 años.",
            "benefits": "Matrícula académica 100% cubierta, estipendio mensual de manutención (GBP 1,300 a 1,600/mes), pasajes aéreos de ida y vuelta, tarifa de Student Visa y eventos oficiales FCDO.",
            "slots": 25,
            "slug": "chevening-uk-beca",
            "organization_name": "FCDO UK / Chevening",
            "status": "approved",
            "short_description": "Cursea tu maestría de 1 año totalmente financiada en las mejores universidades del Reino Unido.",
            "activities": [
                "Estudios de maestría intensivos de 1 año 🎓",
                "Recepciones oficiales y conferencias de liderazgo en la FCDO 🏛️",
                "Participación en la Chevening Alumni Association 🌍",
                "Viajes académicos e inmersión cultural británica 🇬🇧"
            ],
            "requirements": [
                "Título universitario de Licenciatura",
                "Mínimo 2 años de experiencia laboral comprobable (2.800 horas)",
                "Postular a 3 programas de maestría elegibles en el Reino Unido",
                "Compromiso de regresar a Bolivia por al menos 2 años tras la graduación"
            ],
            "benefits_json": [
                "100% de aranceles universitarios de maestría cubiertos 📜",
                "Estipendio mensual de manutención libre de impuestos 💶",
                "Vuelos internacionales de ida y vuelta en clase económica ✈️",
                "Reembolso de tarifa de Student Visa y prueba de salud TB 🛡️"
            ],
            "dates_info": "Convocatoria anual: Apertura Agosto - Cierre Noviembre",
            "support_ai": [
                "Redactor de ensayos Chevening (Liderazgo, Networking, Plan de Carrera)",
                "Calculador de 2,800 horas de experiencia laboral",
                "Simulador de entrevista en la Embajada Británica"
            ],
            ...
            "video_url": "https://www.youtube.com/watch?v=hHDTKvt4yIY",
            "image_url": "/assets/beca_chevening_uk/University-of-Oxford.jpg",
            "is_demo": False
        },
        {
            "title": "Global UGRAD (Global Undergraduate Exchange Program)",
            "description": "Programa de becas integrales para que futuros líderes universitarios bolivianos experimenten el sistema educativo de EE. UU., compartan su cultura y cursen 1 semestre académico totalmente financiado.",
            "type": "scholarship",
            "organization": "U.S. Department of State (ECA) / World Learning",
            "country": "Estados Unidos",
            "city": "Varias ciudades de EE.UU. (Colorado, Minnesota, Kansas, Missouri, West Virginia, etc.)",
            "institution": "60+ Universidades e Institutos de Educación Superior en EE.UU.",
            "level": "Pregrado / Intercambio (Non-Degree)",
            "funding_type": "100% Total (Matrícula + Residencia + Comida + Vuelos + Seguro + Estipendio)",
            "area": "Todas las disciplinas de pregrado (STEM, Ciencias Sociales, Humanidades, Negocios)",
            "language": "Inglés (Duolingo / TOEFL)",
            "duration": "1 Semestre Académico (4 a 5 meses)",
            "deadline": datetime.date(2026, 12, 15),
            "official_url": "https://bo.usembassy.gov/es/education-exchanges-es/",
            "eligibility": "Estudiantes universitarios bolivianos de 18 a 24 años que tengan al menos 1 semestre por cursar en Bolivia al retornar.",
            "benefits": "Vuelos internacionales ida y vuelta, matrícula universitaria 100%, residencia en campus con plan de comidas completo, seguro médico ASPE, estipendio mensual en dólares y taller en Washington D.C.",
            "slots": 300,
            "slug": "global-ugrad-eeuu-beca",
            "organization_name": "U.S. Department of State / World Learning",
            "status": "approved",
            "short_description": "Cursea 1 semestre universitario totalmente financiado en Estados Unidos.",
            "activities": [
                "Estudios de pregrado durante 1 semestre académico en EE.UU. 🎓",
                "Voluntariado y servicio comunitario (mínimo 20 horas) 🤝",
                "Taller nacional de liderazgo en Washington D.C. 🏛️",
                "Inmersión cultural y red global con estudiantes de 60+ países 🌍"
            ],
            "requirements": [
                "Nacionalidad boliviana y residencia en Bolivia",
                "Tener entre 18 y 24 años cumplidos al iniciar el programa",
                "Ser estudiante regular de pregrado a tiempo completo con buen promedio",
                "Tener al menos 1 año lectivo o 1 semestre pendiente por cursar tras retornar"
            ],
            "benefits_json": [
                "Matrícula académica y aranceles del campus 100% cubiertos 📜",
                "Alojamiento en residencia estudiantil y plan de comidas completo (Meal Plan) 🏠",
                "Boletos de avión internacionales de ida y vuelta ✈️",
                "Seguro de salud de intercambio ASPE y estipendio mensual en USD 💵"
            ],
            "dates_info": "Convocatoria anual: Apertura Noviembre - Cierre Diciembre/Enero",
            "support_ai": [
                "Redactor de ensayos de motivación y servicio comunitario UGRAD",
                "Preparador de entrevista de selección con la Embajada de EE.UU.",
                "Evaluador de elegibilidad académica y cálculo de semestres restantes"
            ],
            "facebook_url": "https://www.facebook.com/GlobalUGRAD/",
            "instagram_url": "https://www.instagram.com/worldlearning/",
            "video_url": "https://www.youtube.com/watch?v=u13tvhe8l9w",
            "image_url": "/assets/beca_global_ugrad/Colorado State University.jpg",
            "is_demo": False
        },
        {
            "title": "Beca Monbukagakusho del Gobierno del Japón (MEXT)",
            "description": "El programa de becas más prestigioso del Gobierno del Japón. Ofrece formación universitaria de pregrado y posgrado totalmente financiada: 1 año de idioma y cultura japonesa + carrera completa en universidades nacionales de élite.",
            "type": "scholarship",
            "organization": "Ministerio de Educación, Cultura, Deportes, Ciencia y Tecnología del Japón (MEXT) / Embajada del Japón en Bolivia",
            "country": "Japón",
            "city": "Tokio, Kioto, Osaka, Sendai, Fukuoka",
            "institution": "The University of Tokyo, Kyoto University, Tohoku University, Tokyo Tech, Osaka University y universidades nacionales públicas de Japón",
            "level": "Pregrado (5-6 años) & Posgrado (Maestría/Doctorado)",
            "funding_type": "100% Total (Matrícula + 1 año idioma + Estipendio JPY + Vuelos + Seguro)",
            "area": "Ciencias Sociales, Humanidades, Derecho, Economía, Ciencias Puras, Ingenierías, Agricultura, Veterinaria, Medicina, Odontología",
            "language": "Inglés (IELTS/TOEFL) e idioma Japonés (curso preparatorio incluido)",
            "duration": "5 a 6 años (Pregrado) / 2 a 5 años (Posgrado)",
            "deadline": datetime.date(2026, 6, 4),
            "official_url": "https://www.bo.emb-japan.go.jp/itpr_es/becas-pregrado.html",
            "eligibility": "Bachilleres bolivianos (nacidos después del 2 de abril de 2001) para pregrado o universitarios graduados (nacidos después del 2 de abril de 1991) para posgrado, con excelencia académica.",
            "benefits": "Matrícula completa 100% exenta, exención de tasa de examen de ingreso, 1 año de curso intensivo de japonés, estipendio mensual (117.000 JPY a 145.000 JPY/mes), boletos de avión internacional ida y vuelta y seguro de salud.",
            "slots": 30,
            "slug": "mext-japon-beca",
            "organization_name": "MEXT Japón / Embajada del Japón",
            "status": "approved",
            "short_description": "Cursea tu carrera completa o posgrado 100% financiado en las mejores universidades del Japón.",
            "activities": [
                "1 año preparatorio intensivo de idioma y cultura japonesa 🇯🇵",
                "Carrera universitaria completa o programa de investigación posdoctoral 🎓",
                "Participación en laboratorios científicos y proyectos tecnológicos 🔬",
                "Integración en la Asociación de Exbecarios del Japón en Bolivia (ABENJAP) 🌍"
            ],
            "requirements": [
                "Nacionalidad boliviana y residencia en Bolivia",
                "Cumplir con el rango de edad (Pregrado: 17-24 años; Posgrado: hasta 35 años)",
                "Título de Bachiller (para Pregrado) o Título de Pregrado (para Posgrado)",
                "Rendir exámenes escritos de idiomas y materias en la Embajada (La Paz) o Consulado (Santa Cruz)"
            ],
            "benefits_json": [
                "100% de aranceles universitarios y exámenes de admisión exentos 📜",
                "1 año preparatorio intensivo de idioma japonés incluido 🗣️",
                "Estipendio mensual de manutención libre de impuestos (117.000 a 145.000 JPY) 💶",
                "Pasajes aéreos internacionales de ida y vuelta en clase económica ✈️"
            ],
            "dates_info": "Convocatoria anual: Cierre en Junio (Entrega de sobre físico en Embajada La Paz o Consulado Santa Cruz)",
            "support_ai": [
                "Simulador de exámenes pasados MEXT de Matemáticas y Ciencias",
                "Generador de Plan de Investigación (Field of Study) para posgrado",
                "Entrenador de entrevista en la Embajada del Japón en La Paz"
            ],
            "facebook_url": "https://www.facebook.com/mextjapan",
            "youtube_url": "https://www.youtube.com/watch?v=aLySvgUWChc",
            "video_url": "https://www.youtube.com/watch?v=aLySvgUWChc",
            "image_url": "/assets/beca_mext_japon/_Tokyo_University_3.jpg",
            "is_demo": False
        },
        {
            "title": "Beca Stipendium Hungaricum (Gobierno de Hungría - SEGIB)",
            "description": "El programa estrella del Gobierno de Hungría para internacionalizar la educación superior. Bolivia es elegible mediante el convenio marco SEGIB con 30+ universidades participantes y más de 900 carreras y posgrados dictados 100% en inglés.",
            "type": "scholarship",
            "organization": "Gobierno de Hungría (Tempus Public Foundation) / SEGIB",
            "country": "Hungría",
            "city": "Budapest, Debrecen, Szeged, Pécs, Miskolc",
            "institution": "Eötvös Loránd University (ELTE), University of Debrecen, University of Szeged, Semmelweis University, University of Pécs",
            "level": "Pregrado (3-4 años), Maestría (1.5-2 años) & Doctorado (4 años)",
            "funding_type": "100% Total (Matrícula exenta + Alojamiento/40k HUF + Estipendio mensual + Seguro Médico)",
            "area": "Ciencias de la Computación, Ingenierías, Biotecnología, Medicina, Relaciones Internacionales, Economía, Humanidades, Artes",
            "language": "Inglés (Mínimo B2 / IELTS / TOEFL / Examen Universitario) u Húngaro",
            "duration": "1 a 4 años según nivel de estudio",
            "deadline": datetime.date(2026, 1, 15),
            "official_url": "https://stipendiumhungaricum.hu/",
            "eligibility": "Estudiantes y graduados bolivianos (Bolivia elegible vía marco SEGIB) con título de bachiller o licenciatura y nivel de inglés B2.",
            "benefits": "Matrícula universitaria 100% exenta, hospedaje gratuito en residencia o 40.000 HUF/mes para alquiler, estipendio mensual (43.700 HUF pregrado/maestría; hasta 180.000 HUF doctorado) y seguro médico nacional de salud de 65.000 HUF/año.",
            "slots": 40,
            "slug": "stipendium-hungaricum-beca",
            "organization_name": "Gobierno de Hungría / Tempus Public Foundation",
            "status": "approved",
            "short_description": "Cursea tu pregrado o maestría 100% financiada en inglés en Hungría con el respaldo de SEGIB.",
            "activities": [
                "Estudios universitarios de licenciatura o maestría 100% en inglés en Europa Central 🇪🇺",
                "Estancia en residencias universitarias o departamentos en Budapest, Debrecen o Szeged 🏠",
                "Permiso legal para trabajar a tiempo parcial (hasta 30 horas semanales) 💼",
                "Participación en la red Alumni Network Hungary y eventos multiculturales 🌍"
            ],
            "requirements": [
                "Ciudadanía boliviana y residencia en Bolivia",
                "Título de Bachiller (para Pregrado) o Título Universitario (para Maestría y Doctorado)",
                "Certificado de idioma inglés B2 o rendir el test de la universidad anfitriona",
                "Certificado médico oficial firmado por médico titulado",
                "Postular online en apply.stipendiumhungaricum.hu (máximo 2 programas) antes del 15 de Enero"
            ],
            "benefits_json": [
                "100% de la colegiatura universitaria exenta 📜",
                "Residencia universitaria gratuita o subsidio mensual de 40.000 HUF para alquiler 🏠",
                "Estipendio mensual de manutención libre de impuestos (43.700 a 180.000 HUF) 💶",
                "Seguro nacional de salud público de Hungría (hasta 65.000 HUF/año) 🏥"
            ],
            "dates_info": "Convocatoria anual: Apertura Noviembre - Cierre el 15 de Enero a las 14:00 CET",
            "support_ai": [
                "Redactor de Carta de Motivación Stipendium Hungaricum",
                "Buscador Inteligente en el Catálogo de 900+ Programas en Inglés",
                "Entrenador de Entrevista Universitaria Online"
            ],
            "facebook_url": "https://www.facebook.com/profile.php?id=100044265857816",
            "youtube_url": "https://www.youtube.com/@studyinhungary4284",
            "video_url": "https://www.youtube.com/watch?v=8Bkqt08pBH0",
            "image_url": "/assets/beca_stipendium_hungaricum/Universidad Eötvös Loránd - ELTE.jpg",
            "is_demo": False
        },
        {
            "title": "Becas SISS / Global Professionals (Instituto Sueco - Suecia)",
            "description": "El programa oficial del Gobierno de Suecia enfocado en desarrollar líderes globales comprometidos con los Objetivos de Desarrollo Sostenible (Agenda 2030). Financiamiento 100% total para maestrías en inglés en universidades suecas.",
            "type": "scholarship",
            "organization": "Gobierno de Suecia (Instituto Sueco / Swedish Institute - SI)",
            "country": "Suecia",
            "city": "Estocolmo, Lund, Uppsala, Gotemburgo, Umeå",
            "institution": "KTH Royal Institute of Technology, Lund University, Uppsala University, Stockholm University, Karolinska Institutet y universidades suecas asociadas",
            "level": "Maestrías (1 a 2 años lectivos)",
            "funding_type": "100% Total (Matrícula exenta + Estipendio mensual 12.000 SEK + Subsidio de viaje 15.000 SEK + Red NFGP)",
            "area": "STEM, Gobernanza, Salud Pública, Sostenibilidad, Innovación, Emprendimiento, Ciencias Sociales",
            "language": "Inglés (100% dictado en inglés)",
            "duration": "1 a 2 años de maestría",
            "deadline": datetime.date(2026, 2, 25),
            "official_url": "https://si.se/en/apply/scholarships/swedish-institute-scholarships-for-global-professionals/",
            "eligibility": "Profesionales bolivianos (Bolivia es 1 de los 34 países elegibles) con al menos 3.000 horas de experiencia laboral acumulada antes de febrero de 2026 y experiencia de liderazgo demostrable.",
            "benefits": "Matrícula universitaria 100% cubierta directamente por el SI a la universidad, estipendio mensual libre de impuestos de 12.000 SEK para costo de vida, subsidio de viaje de 15.000 SEK (pago único) y membresía vitalicia en la Sweden Alumni Network.",
            "slots": 25,
            "slug": "swedish-institute-siss-beca",
            "organization_name": "Instituto Sueco (SI) / Swedish Institute",
            "status": "approved",
            "short_description": "Cursea tu maestría 100% financiada en Suecia con 12.000 SEK mensuales de estipendio.",
            "activities": [
                "Estudios de maestría 100% en inglés en universidades suecas de élite 🇸🇪",
                "Participación activa en eventos y talleres de la red SI Network for Global Professionals (NFGP) 🌍",
                "Permiso legal de trabajo a tiempo parcial durante el periodo de estudios en Suecia 💼",
                "Integración continua en la Sweden Alumni Network para proyectos sostenibles posgrado 🚀"
            ],
            "requirements": [
                "Ciudadanía boliviana (Bolivia elegible entre los 34 países del SI)",
                "Demostrar mínimo 3.000 horas de experiencia laboral acumuladas (máximo 3 empleadores) antes de febrero",
                "Demostrar experiencia de liderazgo comprobada en empleo o sociedad civil",
                "Haber postulado previamente a una maestría elegible en universityadmissions.se (16 Oct - 15 Ene) y ser admitido el 26 de marzo",
                "Presentar los formularios modelo estandarizados obligatorios publicados por el Instituto Sueco"
            ],
            "benefits_json": [
                "100% de la matrícula universitaria pagada directamente por el SI a la universidad 📜",
                "Estipendio mensual de manutención libre de impuestos de 12.000 SEK 💶",
                "Subsidio de viaje aéreo internacional de 15.000 SEK (pago único) ✈️",
                "Membresía en la red de liderazgo NFGP y Sweden Alumni Network 🤝"
            ],
            "dates_info": "Fechas clave: Postulación a universidad en University Admissions (Oct-Ene) ➔ Portal de Beca SI (9 al 25 de Febrero a las 14:59 CET)",
            "support_ai": [
                "Calculador Inteligente de 3.000 Horas Laborales",
                "Asistente de Redacción de Certificados de Liderazgo Modelo SI",
                "Evaluador de Alineación con los Objetivos de Desarrollo Sostenible (ODS)"
            ],
            "facebook_url": "https://www.facebook.com/svenskainstitutet",
            "youtube_url": "https://www.youtube.com/watch?v=L8WCWaWE61c",
            "video_url": "https://www.youtube.com/watch?v=L8WCWaWE61c",
            "image_url": "/assets/beca_siss_suecia/1. KTH Royal Institute of Technology (Estocolmo).jfif",
            "is_demo": False
        },
        {
            "title": "Becas del Gobierno de Turquía (Türkiye Bursları)",
            "description": "Programa gubernamental de becas integrales que combina la excelencia académica con una inmersión cultural profunda. Ofrece 208 universidades participantes, 40.091 programas de educación elegibles, 1 año preparatorio de idioma turco TÖMER gratuito, residencia y pasajes aéreos.",
            "type": "scholarship",
            "organization": "Gobierno de la República de Turquía (YTB - Presidencia de Turcos en el Extranjero)",
            "country": "Turquía",
            "city": "Estambul, Ankara, Esmirna, Bursa, Antalya",
            "institution": "Istanbul University, Middle East Technical University (METU), Boğaziçi University, Ankara University, Bilkent University y 200+ universidades turcas",
            "level": "Pregrado (4-6 años), Maestría (2 años) & Doctorado (4 años)",
            "funding_type": "100% Total (Matrícula + 1 año idioma turco TÖMER + Residencia + Estipendio mensual + Vuelos + Seguro)",
            "area": "Ingenierías, Ciencias de la Salud, Medicina, Odontología, Relaciones Internacionales, Administración, Derecho, Humanidades, Artes",
            "language": "Turco (1 año preparatorio gratuito incluido) o Inglés (TOEFL/IELTS para programas en inglés)",
            "duration": "3 a 7 años según nivel (incluyendo 1 año de idioma turco)",
            "deadline": datetime.date(2026, 2, 20),
            "official_url": "https://www.turkiyeburslari.gov.tr/",
            "eligibility": "Estudiantes y graduados bolivianos con promedio mínimo del 70% (Pregrado), 75% (Maestría/Ph.D.) o 90% (Medicina) y dentro del rango de edad por nivel.",
            "benefits": "Matrícula universitaria 100% exenta, curso de idioma turco TÖMER de 1 año gratuito, alojamiento gratuito en residencias universitarias públicas, boletos de avión internacional ida y vuelta (Bolivia ⇄ Turquía) con Turkish Airlines, estipendio mensual (3,500 TRY pregrado, 5,000 TRY maestría, 6,500 TRY doctorado) y seguro de salud.",
            "slots": 50,
            "slug": "turkiye-burslari-beca",
            "organization_name": "Gobierno de Turquía / YTB",
            "status": "approved",
            "short_description": "Cursea tu pregrado o maestría 100% financiada en Turquía con 1 año de turco gratis y residencia.",
            "activities": [
                "1 año preparatorio intensivo del idioma turco en centros TÖMER 🇹🇷",
                "Carrera de pregrado o posgrado completa en 1 de las 208 universidades turcas elegibles 🎓",
                "Estancia en residencias universitarias públicas del Estado turco (KYK) 🏠",
                "Participación en la red global de 150.000+ exbecarios Türkiye Alumni 🌍"
            ],
            "requirements": [
                "Nacionalidad boliviana (o ciudadanías internacionales elegibles excepto turca)",
                "Límites de edad: Pregrado (< 21 años), Maestría (< 30 años), Doctorado (< 35 años)",
                "Promedio mínimo exigido: 70% (Pregrado), 75% (Maestría/Ph.D.), 90% (Medicina/Odontología)",
                "Título de Bachiller o Título Universitario según nivel",
                "Postulación online 100% gratuita en tbbs.turkiyeburslari.gov.tr seleccionando hasta 12 opciones antes del 20 de Febrero"
            ],
            "benefits_json": [
                "100% de la colegiatura y matrícula universitaria cubierta 📜",
                "1 año preparatorio intensivo de idioma turco TÖMER totalmente gratuito 🗣️",
                "Alojamiento gratuito en residencias universitarias públicas del Estado 🏠",
                "Pasajes aéreos internacionales de ida y vuelta en clase económica (Turkish Airlines) ✈️",
                "Estipendio mensual libre de impuestos de 3,500 TRY a 6,500 TRY 💶"
            ],
            "dates_info": "Convocatoria anual: Apertura 10 de Enero - Cierre el 20 de Febrero a las 23:59 (Hora de Turquía)",
            "support_ai": [
                "Buscador de Universidades y Ciudades Turcas (12 elecciones)",
                "Redactor de Letter of Intent (Carta de Intención para YTB)",
                "Simulador de Entrevista Diplomática Türkiye Bursları"
            ],
            "facebook_url": "https://www.facebook.com/turkiyeburslari/",
            "youtube_url": "https://www.youtube.com/@TurkiyeBurslarii",
            "instagram_url": "https://www.instagram.com/turkiyeburslari/",
            "video_url": "https://www.youtube.com/watch?v=uKXbXoMeQuY",
            "image_url": "/assets/beca_turkiye_burslari/1.png",
            "is_demo": False
        },
        {
            "title": "Programa de Voluntarios de las Naciones Unidas (UN Youth Volunteers)",
            "description": "Los voluntarios trabajan en agencias de la ONU (como UNICEF, PNUD o ACNUR) apoyando proyectos de desarrollo social, derechos humanos, salud y educación en contextos de crisis o desarrollo.\n\nEl Programa de Voluntarios de las Naciones Unidas (UNV) contribuye a la paz y al desarrollo en todo el mundo a través del voluntariado. Los Jóvenes Voluntarios de la ONU son un recurso vital para la acción transformadora de la Agenda 2030.\n\nFinanciamiento Total: Incluye estipendio mensual de subsistencia (VLA), gastos de viaje de ida y vuelta, seguro médico completo de las Naciones Unidas y subsidio de reasentamiento.",
            "type": "volunteering",
            "organization": "Programa de Voluntarios de las Naciones Unidas (UNV)",
            "country": "Global (África, Asia, Latinoamérica y Medio Oriente)",
            "deadline": datetime.date(2026, 12, 31),
            "eligibility": "Jóvenes bolivianos entre 18 y 26 años con vocación social, título universitario o técnico (según la vacante) y dominio de inglés o francés.",
            "benefits": "Financiamiento 100% Total (Estipendio mensual VLA, gastos de viaje, seguro médico integral y subsidio de instalación/reasentamiento).",
            "slots": 40,
            "slug": "un-voluntariado",
            "organization_name": "UNV - Naciones Unidas",
            "status": "open",
            "short_description": "Programa oficial de voluntariado de las Naciones Unidas para jóvenes entre 18 y 26 años en proyectos de desarrollo global.",
            "activities": [
                "Apoyo directo a proyectos de UNICEF, PNUD, ACNUR y agencias de la ONU 🇺🇳",
                "Intervención en desarrollo social, derechos humanos, salud y educación 🤝",
                "Trabajo de campo en contextos de desarrollo y respuesta humanitaria 🌍",
                "Monitoreo de proyectos y coordinación comunitaria internacional 🌱"
            ],
            "requirements": [
                "Ser joven boliviano/a entre 18 y 26 años",
                "Título universitario o técnico (según requerimiento de la vacante)",
                "Dominio de idioma inglés o francés",
                "Compromiso con los valores fundamentales de las Naciones Unidas",
                "Vocación de servicio social y adaptabilidad intercultural"
            ],
            "benefits_json": [
                "Financiamiento 100% total por la ONU 💰",
                "Estipendio mensual de subsistencia (VLA) 💵",
                "Gastos de viaje y pasajes internacionales ✈️",
                "Seguro médico internacional completo de la ONU 🛡️",
                "Subsidio de reasentamiento e instalación 🏠"
            ],
            "dates_info": "Convocatorias: Recurrentes durante todo el año en la plataforma Unified Volunteering Platform (UVP)",
            "support_ai": [
                "Orientación sobre el perfil y competencias exigidas por las Naciones Unidas",
                "Optimización de CV formato ONU y perfil en la plataforma UVP",
                "Redacción de declaración de motivación para agencias de la ONU"
            ],
            "facebook_url": "https://www.facebook.com/unvolunteers",
            "instagram_url": "https://www.instagram.com/unvolunteers/?hl=es",
            "youtube_url": "https://www.youtube.com/@unv",
            "video_url": "https://www.youtube.com/watch?v=acsOP8sBmBY",
            "image_url": "../../assets/voluntariado_un_voluntier/imagenes/uf16pjn-12381p_0654-(1).jpg",
            "is_demo": False,
            "testimonials": [
